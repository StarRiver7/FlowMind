...
class UserServiceTest {
    ...
    void shouldAssignRoles() {
        ...
        doReturn(1).when(userRoleMapper).insert((com.enterprise.aiagent.domain.model.entity.UserRole) any());

        assertDoesNotThrow(() -> userService.assignRoles(req));
        verify(userRoleMapper, times(2)).insert((com.enterprise.aiagent.domain.model.entity.UserRole) any());
    }
